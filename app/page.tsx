      ...
      <div className="bg-gray-100">
        <div className="bg-gray-100 container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            <b>Share your opinions</b> and <b>driven changes</b> in <b>universities</b>.
          </p>
          <div className="flex justify-center space-x-4">
            <a
              href="#"
              className="bg-blue-600 text-white py-3 px-6 rounded-md text-lg hover:bg-blue-500 transition"
            >
              Take Survey
            </a>
          </div>
          ...
          <div className="text-center">
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-gray-600">Universitas</p>
              </div>
              <div>
                <h3 className="text-2xl font-bold">2.000.000</h3>
